define(['jquery', 'underscore', 'Backbone'
        ,'text!views/budget/reports/categoryWiseExpnReportQuarterly.tpl'
        , 'collections/budget/categoryExpenseCollections'
    ],
        
function ($, _, Backbone
			, categoryWiseExpnReportTemplateQuarterly
        	...
        	if(expenceAndBudgetList !=null){
	        	if(expenceAndBudgetList.length>0){
	        		for(var i=0;i<expenceAndBudgetList.length;i++){
	        			if(expenceAndBudgetList[i].expenceDescription=="OverAllQuartlyExpense"){
							...
							//monthval = expenceAndBudgetList[i].periodValue + " " + expenceAndBudgetList[i].yearValue;
							//console.log("=================="+expenceAndBudgetList[i].periodValue+"==================="+expenceAndBudgetList[i].yearValue+"===================");
	        			}
	        		}
	        		var firstYearVal = expenceAndBudgetList[0].year_value;
	        		var lastYearVal = expenceAndBudgetList[(expenceAndBudgetList.length-1)].year_value;
	        		if(firstYearVal == lastYearVal) {
	        			monthval = firstYearVal;
	        		} else {
	        			monthval = firstYearVal+" - "+lastYearVal;
	        		}
	        		//monthval = expenceAndBudgetList[0].monthDesc + " " + expenceAndBudgetList[0].year_value;
	        		
	        	}
        	}
        	this.$el.html(_.template(categoryWiseExpnReportTemplateQuarterly,{expc:expc,budg:budg,monthval:monthval,mon:mon,categoryName:categoryName,categoryId:categoryId})).i18n();
