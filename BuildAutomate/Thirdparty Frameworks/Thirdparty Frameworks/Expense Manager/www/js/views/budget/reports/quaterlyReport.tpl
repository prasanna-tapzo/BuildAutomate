...
<h1 class="inner_title" style="margin:10px 0 10px 0">
	<span id="screentitle">Budgets vs Expenses</span>
</h1>
<!--/tabmenu-->
	<div class="row tabmenu">
           	<!-- <a href="#/weekly" >WEEKLY</a> -->
            <a href="#/monthly">MONTHLY</a>
            <a href="#/quarterly" class="padtp active">QUARTERLY</a>
...
<div class="row">
		<% if(listAccountTransactionReport!=null && listAccountTransactionReport.length>0){ %>
				<div class="panel m-a-0">
									...
									<div class="cat_grp" style="margin:0 5px 0 5px;">
										<a id="txnList" class="showMyModal">
											...
											<div class="media-body">
												...
												<div class="text-muted fn-size15"><%-data.category%>&nbsp;|&nbsp;<!-- <%-data.periodValue%> --> <%-data.txn_Timestamp%></div>
