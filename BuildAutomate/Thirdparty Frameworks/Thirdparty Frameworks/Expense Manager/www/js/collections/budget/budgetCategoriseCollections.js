define(['underscore','Backbone','models/budgets/budgetCategoriseModel'], 
	function(_, Backbone, budgetCategoriseModel){
	
	var els = new EncryptedLocalStorage('secret'); 
	var categoriseCollections = Backbone.Collection.extend({
    	model: budgetCategoriseModel,
