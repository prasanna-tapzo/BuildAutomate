define(['underscore', 'Backbone'], 
	function(_, Backbone) {
		var depositsGardianValidationModel = Backbone.Model.extend({
			url: function(){
  			...
  			validation: {
    			...
    			guardianname: {
	     			required: true,
	    			msg: "validation.wealth.general.guardiannameisnotnull"
    			},
    			guardiancontactno: {
	     			required: true,
	    			msg: "validation.wealth.general.guardiancontactnoisnotnull"
    			},
    			guardaddr1: {
	     			required: true,
	    			msg: "validation.wealth.general.guardaddr1isnotnull"
    			},
    			guardaddr2: {
	     			required: true,
	    			msg: "validation.wealth.general.guardaddr2isnotnull"
    			},
    			/*guardaddr3: {
	     			required: true,
	    			msg: "validation.wealth.general.guardaddr3isnotnull"
    			},
    			guarlandmark: {
	     			required: true,
	    			msg: "validation.wealth.general.guarlandmarkisnotnull"
    			},*/
                ...
                relationtonom:{
                    required: true,
                    msg: "validation.wealth.general.relationtonom"
                },                
    ...
    return depositsGardianValidationModel;
});