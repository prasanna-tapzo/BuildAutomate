...
gpg --quiet --batch --yes --decrypt --passphrase="$IOS_KEYS" --output ./.github/secrets/FedMobileDCRelease.mobileprovision ./.github/secrets/FedMobileDCRelease.mobileprovision.gpg
...
cp ./.github/secrets/FedMobileDCRelease.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/FedMobileDCRelease.mobileprovision
