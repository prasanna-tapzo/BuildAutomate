...
#ifndef ONEDIRECTCHATSDK_SWIFT_H
#define ONEDIRECTCHATSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OnedirectChatSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@protocol PartnerConfig;

SWIFT_CLASS("_TtC16OnedirectChatSdk10ChatConfig")
...
SWIFT_CLASS("_TtC16OnedirectChatSdk12LoaderScreen")
@interface LoaderScreen : UIViewController
...
typedef SWIFT_ENUM(NSInteger, NetworkEnvironment, open) {
  NetworkEnvironmentDev = 0,
  NetworkEnvironmentQa = 1,
  NetworkEnvironmentProduction = 2,
  NetworkEnvironmentStaging = 3,
};

@class UIColor;

SWIFT_PROTOCOL("_TtP16OnedirectChatSdk13PartnerConfig_")
@protocol PartnerConfig
