...
#ifndef BILLPAYMENTS_SWIFT_H
#define BILLPAYMENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BillPayments",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP12BillPayments10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC12BillPayments8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(BillPayments))
...
@interface DropDown (SWIFT_EXTENSION(BillPayments)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC12BillPayments12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(BillPayments))
- (void)awakeFromNib;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12BillPayments17FloatingTextField")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12BillPayments26EnhanceFloatTextFieldLabel")
...
SWIFT_CLASS("_TtC12BillPayments16TextViewWithDone")
@interface TextViewWithDone : UITextView
...
@interface UIBarButtonItem (SWIFT_EXTENSION(BillPayments)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(BillPayments)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
