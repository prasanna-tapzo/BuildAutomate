...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Cabs",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Cabs13ARCarMovement")
@interface ARCarMovement : NSObject
/// ARCarMovement delegate.
@property (nonatomic, weak) id <ARCarMovementDelegate> _Nullable delegate;
...
/// \param marker The <em>marker</em> is given marker.
///
/// \param oldCoordinate The <em>oldCoordinate</em> is old value of coordinate.
///
/// \param newCoordinate The <em>newCoordinate</em> is new value of coordinate.
///
/// \param mapView The <em>mapView</em> is represention of view.
///
/// \param bearing The <em>bearing</em> is camera’s position on an arc between directly over the map’s center position and the surface of the Earth. Default value is 0.
///
- (void)arCarMovementWithMarker:(GMSMarker * _Nonnull)marker oldCoordinate:(CLLocationCoordinate2D)oldCoordinate newCoordinate:(CLLocationCoordinate2D)newCoordinate mapView:(GMSMapView * _Nonnull)mapView bearing:(float)bearing;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP4Cabs21ARCarMovementDelegate_")
@protocol ARCarMovementDelegate
/// Tells the delegate that the specified marker will be move with animation.
/// \param marker The <em>marker</em> return updated marker with animation.
///
...
SWIFT_CLASS_NAMED("CabRecentSearchEntity")
@interface CabRecentSearchEntity : NSManagedObject
...
@interface CabRecentSearchEntity (SWIFT_EXTENSION(Cabs))
@property (nonatomic, strong) NSDate * _Nullable insertDate;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC4Cabs10DottedView")
...
@interface UIView (SWIFT_EXTENSION(Cabs))
