...
#ifndef RECHARGE_SWIFT_H
#define RECHARGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Recharge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP8Recharge10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC8Recharge8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(Recharge))
...
@interface DropDown (SWIFT_EXTENSION(Recharge)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8Recharge12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(Recharge))
- (void)awakeFromNib;
...
@interface UIBarButtonItem (SWIFT_EXTENSION(Recharge)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end



@interface UIImageView (SWIFT_EXTENSION(Recharge))
- (void)awakeFromNib;
@end
...
@interface UIView (SWIFT_EXTENSION(Recharge)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(Recharge))
