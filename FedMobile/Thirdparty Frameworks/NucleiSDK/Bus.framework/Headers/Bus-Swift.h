...
SWIFT_CLASS_NAMED("BusRecentSearch")
@interface BusRecentSearch : NSManagedObject
...
@interface BusRecentSearch (SWIFT_EXTENSION(Bus))
- (void)addFiltersObject:(Filter * _Nonnull)value;
- (void)removeFiltersObject:(Filter * _Nonnull)value;
- (void)addFilters:(NSSet * _Nonnull)values;
- (void)removeFilters:(NSSet * _Nonnull)values;
@end
...
@interface BusRecentSearch (SWIFT_EXTENSION(Bus))
@property (nonatomic, strong) NSDate * _Nullable recordCreatedTime;
@property (nonatomic) int64_t travelDate;
@property (nonatomic, strong) City * _Nullable destinationCity;
@property (nonatomic, strong) City * _Nullable sourceCity;
@property (nonatomic, strong) NSSet * _Nullable filters;
@end
...
@interface City (SWIFT_EXTENSION(Bus))
@property (nonatomic) int32_t id;
@property (nonatomic, copy) NSString * _Nullable cityName;
@property (nonatomic, strong) BusRecentSearch * _Nullable sourceRecentSearch;
@property (nonatomic, strong) BusRecentSearch * _Nullable destinationRecentSearch;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC3Bus10DottedView")
...
@interface Filter (SWIFT_EXTENSION(Bus))
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic, copy) NSString * _Nullable imageUrl;
@property (nonatomic) BOOL selected;
@property (nonatomic, copy) NSString * _Nullable subTitle;
@property (nonatomic, strong) BusRecentSearch * _Nullable recentSearch;
@end


SWIFT_CLASS_NAMED("LocationSearch")
@interface LocationSearch : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface LocationSearch (SWIFT_EXTENSION(Bus))
@property (nonatomic, copy) NSString * _Nullable cityName;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC3Bus11RangeSlider")
...
SWIFT_CLASS("_TtC3Bus12SkeletonView")
